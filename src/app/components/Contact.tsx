            ...
            <div className="container-max">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                        ...
                        No job is too big or too small for JJ Metal Works.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">123 Industrial Way<br />Metal City, MC 12345</p>
                        ...
                        <div className="bg-gradient-to-br from-blue-600 to-blue-800 text-white rounded-2xl p-8">
                            <h4 className="text-xl font-bold mb-4">Why Choose JJ Metal Works?</h4>
